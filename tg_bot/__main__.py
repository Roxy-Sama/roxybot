...
Hello {} My name is Roxy! I am a magician and also a teacher! I can also help you in the group.
Type /help to view My command


"""


BOT_IMG = "https://telegra.ph/file/1a21d03b18c840cd9aa87.mp4"




HELP_STRINGS = """
*Helpful Commands :* [.](https://telegra.ph/file/4db25d0732e25c87eb911.jpg)
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[
                        InlineKeyboardButton(
                            text="Add Roxy to your group",
                            url="t.me/{}?startgroup=true".format(context.bot.username))
                    ],
                    [
                        InlineKeyboardButton(
                            text="Support Chat ",
                            url="https://t.me/roxypantsu"),
                        InlineKeyboardButton(
                            text="Updates ",
                            url="https://t.me/roxypantsulog")
                    ],
                    [
                        InlineKeyboardButton(
                            text="help",
                            url="https://t.me/roxymiguridabot?start=help")
                    ]]))
...
#def tg_bot_about_callback(update, context):
    #query = update.callback_query
        ...
        update.effective_message.reply_text("HI, Can i help you?")
